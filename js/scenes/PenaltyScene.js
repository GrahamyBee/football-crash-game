class PenaltyScene extends Phaser.Scene {
    ...
    create() {
        ...
        // Goalkeeper at center of goal (35% down screen - moved back up 2%)
        this.goalkeeper = this.add.image(width / 2, height * 0.35, 'goalkeeper')
            .setScale(0.525)
            .setDepth(1);
        
        // Create 5 clickable zones with random multipliers (in front of goalkeeper)
        this.createGoalZones();
        
        // Football at penalty spot (71% down screen - moved down 5%) - always on top
        this.ball = this.add.image(width / 2, height * 0.71, 'football')
            .setScale(0.15)
            .setDepth(100);
        ...
        // Instructions
        this.add.text(width / 2, 70, 'SELECT WHERE TO SHOOT', {
            fontSize: '28px',
            fontStyle: 'bold',
            fill: '#FFFFFF',
            stroke: '#000000',
